...
AttachHeightLocal = 0.2		#0.2
suspensionLength = 0.5		#0.8

influence = 0.02	#0.02
stiffness = 150.0    #20.0	Dureza del amortiguador
damping = 5.0		#2.0	Suavizado de la amortiguación
compression = 30.0	#4.0	Resistencia a la compresión
friction = 50.0		#10.0
Stability = 0.02	#0.05
force = 200.0		#15.0
ease_steer = 0.9	#0.6
...
def carInit():
	...
	wheelAttachPosLocal = [wheel_wide, wheelFrontOffset, AttachHeightLocal]
	vehicle.addWheel(
		wheel0,
		wheelAttachPosLocal,
		wheelAttachDirLocal,
	...
	wheelAttachPosLocal = [-wheel_wide, wheelFrontOffset, AttachHeightLocal]
	vehicle.addWheel(wheel1,wheelAttachPosLocal,wheelAttachDirLocal,wheelAxleLocal,suspensionLength,wheel_radius,1)

	wheel2 = logic.scene.objects["Wheel2"]
	wheelAttachPosLocal = [wheel_wide, wheelBackOffset, AttachHeightLocal]
	vehicle.addWheel(wheel2,wheelAttachPosLocal,wheelAttachDirLocal,wheelAxleLocal,suspensionLength,wheel_radius,0)

	wheel3 = logic.scene.objects["Wheel3"]
	wheelAttachPosLocal = [-wheel_wide, wheelBackOffset, AttachHeightLocal]
	vehicle.addWheel(wheel3,wheelAttachPosLocal,wheelAttachDirLocal,wheelAxleLocal,suspensionLength,wheel_radius,0)
...
def carHandler():
	...
	linSum = math.sqrt(Xspeed**2 + Yspeed**2)# + Zspeed**2)
	print(linSum)
